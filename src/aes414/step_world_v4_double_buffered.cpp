...
void StepWorldV4DoubleBuffered(world_t &world, float dt, unsigned n)
{
	...
	queue.enqueueWriteBuffer(buffProperties, CL_TRUE, 0, cbBuffer, &world.properties[0]); //write properties data to buffProperties 
...
int main(int argc, char *argv[])
{
	...
	try{
		...
		hpce::aes414::StepWorldV4DoubleBuffered(world, dt, n);
